...
2026-09-21 需求更新：系统默认采用专家八问题框架，先获取结构化证据，再开展分型与领域发现；旧 Q1-Q10 通过 `profileVersion=oomycete_questions_v2` 保持兼容，化合物表格提取继续保留。实施顺序及旧新题迁移见[专家八问题实施路线图](docs/专家八问题结构化与领域发现实施路线图-20260921.md)，原始字段见[专家字段快照](docs/专家八问题字段快照-20260921.json)。
